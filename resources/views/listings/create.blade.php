            ...
            <div class="mb-4 mx-2">
                ...
                <div class="mb-4 mx-2">
                    <label for="is_highlighted" class="inline-flex items-center font-medium text-sm text-gray-700">
                        ...
                        <span class="ml-2">Highlight this post (extra $45)</span>
                    </label>
                </div>
                <div class="mb-6 mx-2">
                ...
                <div class="mb-2 mx-2">
                    ...
                    <input
                        ...
                        value="">
                    <button type="submit" id="form_submit" class="block w-full items-center bg-indigo-500 text-white border-0 py-2 focus:outline-none hover:bg-red-600 rounded text-base mt-4 md:mt-0">Pay + Continue</button>
                </div>
            </form>
        </div>
    </section>
